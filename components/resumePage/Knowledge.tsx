...
export default function Knowledge() {
  return (
    <div className="py-11">
      ...
      <div className="flex gap-6 items-center mb-6">
        <BsCheckLg className="text-main-orange text-2xl" />
        <span className="text-gray-300 text-2xl">Microservices Architecture</span>
      </div>
      ...
      <div className="flex gap-6 items-center mb-6">
        <BsCheckLg className="text-main-orange text-2xl" />
        <span className="text-gray-300 text-2xl">Database Design & Optimization</span>
      </div>

      <div className="flex gap-6 items-center">
        <BsCheckLg className="text-main-orange text-2xl" />
        <span className="text-gray-300 text-2xl">System Design & Scalability</span>
      </div>
    </div>
  );
}
