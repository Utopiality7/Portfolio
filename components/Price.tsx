...
export default function Price({ Icon, packageName, price }: Props) {
  return (
    <div className="py-10 px-12 flex flex-col items-center">
      ...
      <p className="text-2xl text-gray-400 mb-5">AI & API Integration</p>
      <p className="text-2xl text-gray-400 mb-5">Full-Stack Web Development</p>
      <p className="text-2xl text-gray-400 mb-5">Mobile App Development</p>
